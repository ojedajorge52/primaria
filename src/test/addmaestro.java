...
import static test.EditM.person_cedula;

/**
 *
 * @author Jorge
 */
public class addmaestro extends javax.swing.JFrame {

    /**
     * Creates new form addmaestro
     */
    public addmaestro() {
        initComponents();
...
if(nombre.getText()!=""){
        ...
        String sql = String.format("insert into maestro (cedula,nombre,apaterno,amaterno,municipio,localidad,cpostal) value(\"%s\",\"%s\",\"%s\",\"%s\",\"%s\",\"%s\",\"%s\")",ced, nom,ap,am,mun,loc,cp);
...
BD cargar=new BD();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addmaestro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addmaestro().setVisible(true);
